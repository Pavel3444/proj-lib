...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.accordion = function (headActive = 'accordion-head--active', contantActive = 'accordion-content--active', paddings = 40) {
  for (let i = 0; i < this.length; i++) {
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).click(() => {
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i]).toggleClass(headActive);
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i].nextElementSibling).toggleClass(contantActive);
...
Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-panel] .tab-item').tab();
...
_core__WEBPACK_IMPORTED_MODULE_1__["default"].prototype.toggleAttribute = function (attr, attrValue) {
  for (let i = 0; i < this.length; i++) {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.animationOverTime = function (dur, cb, fin) {
  ...
  function _animationOverTime(time) {
    ...
    let complction = Math.min(timeElapsed / dur, 1);
    cb(complction);
...
$('#trigger').click(() => {
  $('#trigger').createModal({
    ...
    btns: {
      count: 3,
      settings: [['Close', ['btn-danger', 'mr-10'], true], ['Save Changed', ['btn-success'], false, () => {
        alert('Data saved');
      }], ['Other button', ['btn-warning', 'ml-10'], false, () => {
        alert('other ');
      }]]
    }
  });
